            ...
            <div class="app-nav" id="app-simple-bar">
                <ul class="main-nav p-0 mt-2">
                    ...
                    <li class="nav-item no-sub"><a
                        ...
                        href="#"><i class="ti ti-help-circle me-2" style="font-size: 25px"></i>Support</a></li>
                    <li class="nav-item no-sub"><a
                        class="nav-link{{ request()->routeIs('client.analyse') ? ' active' : '' }}"
                        href="#"><i class="ti ti-chart-bar me-2" style="font-size: 25px"></i>Analyse
                        (entreprise)</a></li>
                    <li class="nav-item no-sub"><a
                        class="nav-link{{ request()->routeIs('client.mobile') ? ' active' : '' }}"
                        href="#"><i class="ti ti-device-mobile me-2" style="font-size: 25px"></i>Accès Mobile</a>
                    </li>
