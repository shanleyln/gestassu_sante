                        ...
                        <ul class="nav nav-tabs mb-4" id="beneficiaireTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="physique-tab" data-bs-toggle="tab"
                                    data-bs-target="#Beneficiaires" type="button" role="tab"
                                    aria-controls="Beneficiaires" aria-selected="true">
                                    Bénéficiaires
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                ...
                                <div id="BeneficiairesContainer">
                                    <form class="row g-3 align-items-end mb-4">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control shadowInput"
                                                placeholder="Rechercher..." id="searchBeneficiaire">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <table class="table table-bordered align-middle text-center">
                                            <thead style="background-color: #5e2d17; color: white;">
                                                <tr>
                                                    ...
                                                    <th style="background-color: #5e2d17; color: white;">Assuré principal
                                                    </th>
                                                    <th style="background-color: #5e2d17; color: white;">Affilié à</th>
                                                    <th style="background-color: #5e2d17; color: white;">Lien</th>
                                                    <th style="background-color: #5e2d17; color: white;">Date naissance
                                                    </th>
                                        ...
                                        <table class="table table-bordered align-middle text-center">
                                            <thead style="background-color: #5e2d17; color: white;">
                                                <tr>
                                                    ...
                                                    <th style="background-color: #5e2d17; color: white;">Taux de
                                                        remboursement</th>
                                                    <th style="background-color: #5e2d17; color: white;">Plafond annuel
                                                    </th>
                                                </tr>
                                            </thead>
                                ...
                                <div id="TarifsContainer">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered align-middle text-center">
                                            <thead style="background-color: #5e2d17; color: white;">
                                                <tr>
                                                    <th style="background-color: #5e2d17; color: white;">Nature
                                                        bénéficiaire</th>
                                                    <th style="background-color: #5e2d17; color: white;">Prime annuelle
                                                    </th>
                                                </tr>
                                            </thead>
