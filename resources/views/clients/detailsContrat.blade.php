                ...
                <div class="card px-4 py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <ul class="simple-breadcrumbs">
                            ...
                            <li><a href="#" class="active" style="font-size:20px">Détails du contrats</a></li>
                        </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="bg-light border rounded shadow-sm p-3 mb-3">
                            <h6 class="text-white px-3 py-2 mb-3 rounded" style="background-color: #5e2d17;">Informations du
                                contrat
                            </h6>
                        ...
                        <div class="bg-light border rounded shadow-sm p-3">
                            <h6 class="text-white px-3 py-2 mb-3 rounded" style="background-color: #5e2d17;">Statistiques
                            </h6>
                                ...
                                <tbody>
                                    @foreach ($polices as $police)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ $police['ConditionsParticulieres'] }}" target="_blank"
                                                    class="btn"
                                                    style="background-color: #5e2d17;color: white;font-size: 13px;">
                                            ...
                                            <td>
                                                <a href="{{ route('client.policeDetails', ['police' => $police['id']]) }}"
                                                    class="btn"
                                                    style="background-color: #5e2d17;color: white;font-size: 13px;">Détails police</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function filterTable() {
                ...
                rows.forEach(row => {
                    ...
                    const matchText = nom.includes(searchValue) || type.includes(searchValue) || desc
