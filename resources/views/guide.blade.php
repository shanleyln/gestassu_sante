...
<head>
    ...
    <style>
        ...
        header {
            ...
            padding: 25px 0;
            text-align: center;
            border-bottom: 5px solid var(--ingenium-secondary-gold);
        }
        ...
        footer {
            background-color: var(--ingenium-text-dark);
            color: var(--ingenium-text-light);
            text-align: center;
            padding: 20px 0;
            margin-top: 40px;
    ...
    <div class="container">
        ...
        <main>
            ...
            <section id="presentation-plateforme">
                ...
                <h3>Avantages pour les administrateurs de centres de soins</h3>
                <ul>
            ...
            <section id="creation-comptes">
                <h2>3. Création et configuration des comptes prestataires</h2>
                <h3>Réception de vos identifiants</h3>
                ...
                <h3>Première connexion et configuration initiale</h3>
                <ol>
            ...
            <section id="gestion-acces">
                <h2>4. Gestion des accès utilisateurs (rôles, permissions)</h2>
            ...
            <section id="parcours-client">
                <h2>5. Parcours client : Vérification des droits</h2>
            ...
            <section id="utilisation-web">
                <h2>7. Utilisation de la plateforme web pas à pas</h2>
                <h3>Accès à la plateforme</h3>
                <ol>
                    <li>Ouvrez votre navigateur web (Chrome, Firefox, Edge recommandé).</li>
                    <li>Saisissez l'adresse du portail Ingenium Santé (ex: <code><a href="https://ingenium-sante.com">https://ingenium-sante.com</a></code> -
                ...
                <h3>Consultation des garanties et de l'état de la police</h3>
            ...
            <section id="utilisation-sms">
                <h2>8. Utilisation du canal SMS</h2>
                <h3>Quand utiliser le canal SMS ?</h3>
            ...
            <section id="securite-bonnes-pratiques">
                <h2>9. Recommandations de sécurité et bonnes pratiques</h2>
                <ul>
